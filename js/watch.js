	...
	_createClass(Watch, [{
		...
		value: function getElement(element) {
			if (typeof element === "string") {
				...
				throw 'Watch.js: You must provide a selector string, DOM Element or jQuery object to watch. ' + (typeof element === 'undefined' ? 'undefined' : _typeof(element)) + ' provided';
			}
		}
   ...
   */
		...
		value: function observe() {
			...
			var options = Object.assign({
				...
				var response = { entries: entries, observer: observer };
